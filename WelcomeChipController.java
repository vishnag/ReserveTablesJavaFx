...
public class WelcomeChipController {
	@FXML
    ...
    OperationChip operation = new OperationChip(connection);
    @FXML
...
//    private Button drvrButton;
    ...
    private void transitionToCustomerScene(int customerID) {
        ...
        CustomerControllerChip controller = loader.getController();
    ...
    private void transitionToAdminScene() {
        ...
        Parent root = null;
        try {
            root = FXMLLoader.load(getClass().getResource("AdminSceneChip.fxml"));
        } catch (IOException e) {
            e.printStackTrace();
        }
