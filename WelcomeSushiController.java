...
public class WelcomeSushiController {
	@FXML
    ...
    OperationSushi operation = new OperationSushi(connection);
    @FXML
...
//    private Button drvrButton;
    ...
    private void transitionToCustomerScene(int customerID) {
        ...
        try {
            loader = new FXMLLoader(getClass().getResource("CustomerSceneSushi.fxml"));
            root = loader.load();
        ...
        CustomerControllerSushi controller = loader.getController();
    ...
    private void transitionToAdminScene() {
        ...
        Parent root = null;
        try {
            root = FXMLLoader.load(getClass().getResource("AdminSceneSushi.fxml"));
        } catch (IOException e) {
            e.printStackTrace();
        }
