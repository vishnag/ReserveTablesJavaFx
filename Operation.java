...
public class Operation {
	...
	public ArrayList<Item> getMenu(String type) {
		...
		try {
			...
			rs.close();
			statement.close();
			System.out.println("arrayist size from menu "+menu.size());
			return menu;
	...
	public boolean addCustomer(String ln, String fn, String email) {
		String sql_addcustomer = "INSERT INTO customer (email,lastName,firstName,updatedAt) VALUES (?,?,?,CURRENT_TIMESTAMP)";
	...
	public boolean reserveTable(int partySize,Date d,int tID , Customer c) {
		...
		String sql_reserve ="INSERT INTO Reservation (reservationDate,partySize,cID,tID) values(?, ?, ?,?)";
