...
public class WelcomeGeoController {
	@FXML
    ...
    OperationGeo operation = new OperationGeo(connection);
    @FXML
...
//    private Button drvrButton;
    ...
    private void transitionToCustomerScene(int customerID) {
        ...
        try {
            loader = new FXMLLoader(getClass().getResource("CustomerSceneGeo.fxml"));
            root = loader.load();
        ...
        CustomerControllerGeo controller = loader.getController();
    ...
    private void transitionToAdminScene() {
        ...
        Parent root = null;
        try {
            root = FXMLLoader.load(getClass().getResource("AdminSceneGeo.fxml"));
        } catch (IOException e) {
            e.printStackTrace();
        }
