...
public class WelcomeController {
    ...
    void toggleAdminCustomer(ActionEvent event) {
        ...
        if (event.getSource() == customerButton) {
            ...
            empButton.setStyle(" -fx-background-radius: 7;\n" +
                    "    -fx-background-insets: 0;\n" +
                    "    -fx-background-color: #d5d5d5;\n" +
                    "    -fx-text-fill: #000000a9;");
            
            drvrButton.setStyle(" -fx-background-radius: 7;\n" +
                    "    -fx-background-insets: 0;\n" +
                    "    -fx-background-color: #d5d5d5;\n" +
                    "    -fx-text-fill: #000000a9;");
        ...
        } else if (event.getSource() == adminButton || event.getSource() == drvrButton || event.getSource() == empButton) {
            ...
            if(event.getSource() == adminButton) {
	            ...
	            empButton.setStyle(" -fx-background-radius: 7;\n" +
	                    ...
	                    "    -fx-background-color: #d5d5d5;\n" +
	                    "    -fx-text-fill: #000000a9;");
            } else if(event.getSource() == drvrButton) {
            	drvrButton.setStyle(" -fx-background-radius: 7;\n" +
	                    "    -fx-background-insets: 0;\n" +
	                    "    -fx-background-color:  #45BCFA;\n" +
	                    "    -fx-text-fill: white;");
	            ...
	            empButton.setStyle(" -fx-background-radius: 7;\n" +
	                    ...
	                    "    -fx-background-color: #d5d5d5;\n" +
	                    "    -fx-text-fill: #000000a9;");
            } else if(event.getSource() == empButton) {
            	empButton.setStyle(" -fx-background-radius: 7;\n" +
	                    "    -fx-background-insets: 0;\n" +
	                    "    -fx-background-color:  #45BCFA;\n" +
	                    "    -fx-text-fill: white;");
