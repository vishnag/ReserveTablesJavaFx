...
public class WelcomeFrenchController {
	@FXML
    ...
    OperationFrench operation = new OperationFrench(connection);
    @FXML
...
//    private Button drvrButton;
    ...
    private void transitionToCustomerScene(int customerID) {
        ...
        try {
            loader = new FXMLLoader(getClass().getResource("CustomerSceneFrench.fxml"));
            root = loader.load();
        ...
        CustomerControllerFrench controller = loader.getController();
    ...
    private void transitionToAdminScene() {
        ...
        Parent root = null;
        try {
            root = FXMLLoader.load(getClass().getResource("AdminSceneFrench.fxml"));
        } catch (IOException e) {
            e.printStackTrace();
        }
