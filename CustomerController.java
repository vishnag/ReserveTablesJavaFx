...
//        
        	...
        	for(Item arrayelement : arraylist) {
        		...
        		//Label descLabel = new Label(arrayelement.getDescription());
        		Label priceLabel = new Label(" " + String.valueOf(arrayelement.getPrice()));
        		//Label typeLabel = new Label(arrayelement.getType());
//        		Label priceLabel = new Label(String.valueOf(arrayelement.getPrice()));
        		Font newFont = new Font("System", 16);
        	    itemLabel.alignmentProperty();
        		itemLabel.setFont(newFont);
        		/*descLabel.alignmentProperty();
        		descLabel.setFont(newFont);*/
        		priceLabel.alignmentProperty();
        		priceLabel.setFont(newFont);
        		
//        		priceLabel.setFont(newFont);
                hbox1.getChildren().add(itemLabel);
                hbox1.setAlignment(Pos.BASELINE_LEFT);
                hbox1.setSpacing(10);
                hbox2.getChildren().add(priceLabel);
