...
public class WelcomeVapinoController {
	@FXML
...
//    private Button drvrButton;
    ...
    private void transitionToCustomerScene(int customerID) {
        ...
        try {
            loader = new FXMLLoader(getClass().getResource("CustomerSceneVapino.fxml"));
            root = loader.load();
        ...
        CustomerControllerVapino controller = loader.getController();
    ...
    private void transitionToAdminScene() {
        ...
        Parent root = null;
        try {
            root = FXMLLoader.load(getClass().getResource("AdminSceneVapino.fxml"));
        } catch (IOException e) {
            e.printStackTrace();
        }
